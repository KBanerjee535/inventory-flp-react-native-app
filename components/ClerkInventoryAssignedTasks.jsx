...
const ClerkInventoryAssignedTasks = ({navigation}) => {
    ...
    return (
      <Animated.View style={[styles.taskCard, {opacity: fadeAnim}]}>
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.navigate('ClerkInventoryAssignedTasksDetails', {
              activeTabIndex: 0, // Pass the index of the 'Assigned New Tasks' tab
            })
          }>
...
export default ClerkInventoryAssignedTasks;
