    ...
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({focused}) =>
            focused ? (
              <FooterIcon2Act width={25} height={25} />
            ) : (
              <FooterIcon2 width={25} height={25} />
            ),
        }}
      />
      ...
      <Tab.Screen
        name="Snagging"
        component={SnaggingScreen}
        options={{
          tabBarButton: props => <CustomTabButton {...props} />,
          tabBarIcon: ({focused}) =>
            focused ? (
              <FooterIcon3Act width={25} height={25} />
            ) : (
              <FooterIcon3 width={25} height={25} />
            ),
        }}
      />
