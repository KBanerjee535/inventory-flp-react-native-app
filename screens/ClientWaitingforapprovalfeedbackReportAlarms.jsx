...
const items = [
  {
    ...
    screen: 'ClientWaitingforapprovalfeedbackAlarmsDetails',
  },
  {
    id: 2,
    icon: <ItemIcon4 width={24} height={24} />,
...
const ClientWaitingforapprovalfeedbackReportAlarms = ({navigation}) => {
...
export default ClientWaitingforapprovalfeedbackReportAlarms;
