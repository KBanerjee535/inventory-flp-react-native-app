...
const items = [
  {
    ...
    text: 'Water Meter',
    screen: 'ClerkInventoryCompletedTasksReportMeterDetails',
  },
  {
    id: 2,
    icon: <ItemIcon5 width={24} height={24} />,
...
const ClerkInventoryCompletedTasksReportMeterlist = ({navigation}) => {
...
export default ClerkInventoryCompletedTasksReportMeterlist;
