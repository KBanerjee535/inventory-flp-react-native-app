...
const items = [
  {
    ...
    screen: 'ClerkInventoryCompletedTasksReportAlarmDetails',
  },
  {
    id: 2,
    icon: <ItemIcon4 width={24} height={24} />,
...
const ClerkInventoryCompletedTasksReportAlarmlist = ({navigation}) => {
...
export default ClerkInventoryCompletedTasksReportAlarmlist;
