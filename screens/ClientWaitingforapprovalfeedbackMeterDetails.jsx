...
const ClientWaitingforapprovalfeedbackMeterDetails = ({navigation}) => {
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('ClientWaitingforapprovalfeedbackMeters')
            }>
...
export default ClientWaitingforapprovalfeedbackMeterDetails;
