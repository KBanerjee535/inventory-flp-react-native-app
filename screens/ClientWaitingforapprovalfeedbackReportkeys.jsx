...
const items = [
  {
    ...
    screen: 'ClientWaitingforapprovalfeedbackKeysdetails',
  },
  {
    id: 2,
    icon: <ItemIcon3 width={24} height={24} />,
...
const ClientWaitingforapprovalfeedbackReportkeys = ({navigation}) => {
...
export default ClientWaitingforapprovalfeedbackReportkeys;
