...
const items = [
  {
    ...
    text: 'Water Meter',
    screen: 'ClientWaitingforapprovalfeedbackMeterDetails',
  },
  {
    id: 2,
    icon: <ItemIcon5 width={24} height={24} />,
...
const ClientWaitingforapprovalfeedbackMeters = ({navigation}) => {
    ...
    <SafeAreaView style={styles.mainBody}>
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          ...
          <Text style={styles.pagetitleTxt}>Meters</Text>
        </View>
...
export default ClientWaitingforapprovalfeedbackMeters;
