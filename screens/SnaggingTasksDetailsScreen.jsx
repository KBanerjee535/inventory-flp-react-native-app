...
const SnaggingTasksDetailsScreen = ({navigation}) => {
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.info}>
                <Text
                  style={
                    isAccepted ? styles.AcceptedStyle : styles.AssignedStyle
                  }>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.infoindicator}>
                <View
                  style={[styles.infostatusindicator, styles.Snagging]}></View>
                <Text style={styles.infoindicatorTxt}>Snagging</Text>
              </View>
            </View>
            <View style={styles.row}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.info}>
                <Text style={styles.ActionPendingStyle}>
                  {isAccepted ? 'Accepted' : 'Action Pending'}
                </Text>
              </View>
            </View>
            <View style={styles.row}>
          ...
          <View style={styles.BtnGrp}>
            {!isAccepted ? (
              ...
              <TouchableOpacity
                ...
                <Text style={styles.StartBtnTxt}>Start Inspection</Text>
              </TouchableOpacity>
            )}
          </View>
        </ScrollView>
...
export default SnaggingTasksDetailsScreen;
