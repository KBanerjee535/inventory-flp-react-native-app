...
const ClerkInventoryWaitingforApprovalReportAlarmsDetails = ({navigation}) => {
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate(
                'ClerkInventoryWaitingforApprovalReportAlarms',
              )
            }>
...
export default ClerkInventoryWaitingforApprovalReportAlarmsDetails;
