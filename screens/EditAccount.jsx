    ...
    <SafeAreaView style={styles.mainBody}>
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          ...
          <Text style={styles.pagetitleTxt}>Edit Account</Text>
        </View>

        <ScrollView>
          <View style={styles.container}>
            <Text style={styles.subtitel}>First Name</Text>
            <TextInput
              style={[
                styles.searchInput,
            ...
            />
            <Text style={styles.subtitel}>Last Name</Text>
            <TextInput
              style={[
                styles.searchInput,
              ...
              onBlur={() => setFocusedInput(null)}
            />
            <Text style={styles.subtitel}>Phone Number</Text>
            <TextInput
              style={[
                styles.searchInput,
              ...
              onBlur={() => setFocusedInput(null)}
            />
            <Text style={styles.subtitel}>Email</Text>
            <TextInput
              style={[
                styles.searchInput,
                focusedInput === 'input4' && styles.searchFocused,
              ]}
              placeholder="Type"
              onFocus={() => setFocusedInput('input4')}
              onBlur={() => setFocusedInput(null)}
            />
            <Text style={styles.subtitel}>Address</Text>

            <TextInput
              style={[
                styles.input,
                focusedInput === 'input5' && styles.searchFocused,
              ]}
              placeholder="Type"
              multiline
            ...
            <Text style={styles.subtitel}>Address 2</Text>

            <TextInput
              style={[
                styles.input,
                focusedInput === 'input7' && styles.searchFocused,
              ]}
              placeholder="Type"
              multiline
        ...
        <View style={styles.Footer}>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.ViewBtnTxt}>Change Password</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
