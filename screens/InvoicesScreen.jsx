...
import ClientAllInvoices from '../components/ClientAllInvoices';
import ClientOverdueInvoices from '../components/ClientOverdueInvoices';
import ClientUnpaidInvoices from '../components/ClientUnpaidInvoices';
import ClientPaidInvoices from '../components/ClientPaidInvoices';

// Tabs data
const tabLabels = ['All', 'Overdue', 'Unpaid', 'Paid'];
      ...
      <View style={styles.Body}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.contentContainer}>
            {activeTab === 0 ? (
              <ClientAllInvoices navigation={navigation} />
            ) : activeTab === 1 ? (
