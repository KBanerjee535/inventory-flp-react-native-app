...
const ClerkInventoryCompletedTasksReportMeterDetails = ({navigation}) => {
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('ClerkInventoryCompletedTasksReportMeterlist')
            }>
            <PrevPageArrow style={styles.backIcon} />
          </TouchableOpacity>
          <Text style={styles.pagetitleTxt}>Water Meter</Text>
        </View>
        ...
        <ScrollView style={styles.container}>
          <View style={styles.keyInfo}>
            <View style={styles.keyInfoBox}>
              ...
              <Text style={styles.RgtTxt}>Water Meter</Text>
            </View>
            <View style={styles.keyInfoBox}>
              <Text style={styles.LftTxt}>Reading Date</Text>
              <Text style={styles.RgtTxt}>06/10/2025</Text>
            </View>
            <View style={styles.keyInfoBox}>
              <Text style={styles.LftTxt}>Location</Text>
              <Text style={styles.RgtTxt}>Under Stair</Text>
            </View>
          </View>
...
export default ClerkInventoryCompletedTasksReportMeterDetails;
