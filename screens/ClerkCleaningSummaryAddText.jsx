...
import {CleaningSummaryUpdateTextApi, CleaningSummaryAddImageApi} from '../services/apiService';
import { useUserContext } from '../context/UserContext';
import AsyncStorage from '@react-native-async-storage/async-storage';
import Toast from 'react-native-simple-toast';
import { launchCamera, launchImageLibrary } from 'react-native-image-picker';

const ClerkCleaningSummaryAddText = ({navigation}) => {
...
/>
          <Text style={styles.infoTxt}>
            Please describe the cleaning summary of the property
          </Text>
...
export default ClerkCleaningSummaryAddText;
