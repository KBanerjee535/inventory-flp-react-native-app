...
const items = [
  {
    ...
    text: 'Bedroom 1',
    screen: 'ClerkInventoryCompletedTasksReportBedroomDetails',
  },
  {
    id: 2,
    icon: <ItemIcon6 width={24} height={24} />,
...
const ClerkInventoryCompletedTasksReportBedroomlist = ({navigation}) => {
...
export default ClerkInventoryCompletedTasksReportBedroomlist;
