...
const items = [
  {
    ...
    text: 'Bedroom 1',
    screen: 'ClientWaitingforapprovalfeedbackBedroomDetails',
  },
  {
    id: 2,
    icon: <ItemIcon6 width={24} height={24} />,
...
const ClientWaitingforapprovalfeedbackBedroom = ({navigation}) => {
    ...
    <SafeAreaView style={styles.mainBody}>
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          ...
          <Text style={styles.pagetitleTxt}>Bedroom</Text>
        </View>
...
export default ClientWaitingforapprovalfeedbackBedroom;
