...
const items = [
  {
    ...
    screen: 'ClerkInventoryWaitingforApprovalReportAlarmsDetails',
  },
  {
    id: 2,
    icon: <ItemIcon4 width={24} height={24} />,
...
const ClerkInventoryWaitingforApprovalReportAlarms = ({navigation}) => {
...
export default ClerkInventoryWaitingforApprovalReportAlarms;
