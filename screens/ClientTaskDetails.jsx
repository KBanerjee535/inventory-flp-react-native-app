...
const ClientTaskDetails = ({navigation}) => {
  return (
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('ClientTabRoutes')}>
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.info}>07/02/2023</Text>
            </View>
            <View style={styles.row}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.info}>Arlene McCoy</Text>
            </View>
            <View style={styles.row}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.info}>Ryan Cox</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>Tenant Status</Text>
              <Text style={styles.ApproveddStyle}>Approved</Text>
            </View>
          </View>
          <View style={styles.section}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.info}>Jenny Wilson</Text>
            </View>
            <View style={styles.row}>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.info}>
                <Text style={styles.EditedStyle}>Edited</Text>
              </View>
            </View>
            <View style={styles.row}>
          ...
          <View style={styles.BtnGrp}>
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate(
                  'ClientWaitingforapprovalfeedbackReportDetails',
                )
              }>
