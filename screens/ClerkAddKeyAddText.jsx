...
import { KeyAddImageApi, KeyUpdateTextByIdApi } from '../services/apiService';
import { useUserContext } from '../context/UserContext';
import AsyncStorage from '@react-native-async-storage/async-storage';
import Toast from 'react-native-simple-toast';
import { launchCamera, launchImageLibrary } from 'react-native-image-picker';

const ClerkAddKeyAddText = ({navigation}) => {
  const [isFocused, setIsFocused] = useState(false);
const { keysData,seletedJobId } = useUserContext() || {}; // Note the capitalization
...
const handleSaveText = async () => {
  ...
  try {//
    ...
    console.log('Key Update Response:', response);
...
useEffect(() => {
  keysData?.id && setDescription(keysData?.description || '');
}, [keysData?.id]);
    ...
    <SafeAreaView style={styles.mainBody}>
      ...
      <View style={styles.Body}>
        ...
        <ScrollView style={styles.container}>
          ...
          <Text style={styles.infoTxt}>Please describe the key summary</Text>
...
export default ClerkAddKeyAddText;
