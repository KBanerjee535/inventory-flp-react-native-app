...
const ClerkInventoryCompletedTasksReportAlarmDetails = ({navigation}) => {
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('ClerkInventoryCompletedTasksReportAlarmlist')
            }>
            <PrevPageArrow style={styles.backIcon} />
          </TouchableOpacity>
          <Text style={styles.pagetitleTxt}>Carbon Monoxide Alarm</Text>
        </View>
        ...
        <ScrollView style={styles.container}>
          <View style={styles.keyInfo}>
            <View style={styles.keyInfoBox}>
              ...
              <Text style={styles.RgtTxt}>Carbon Monoxide Alarm</Text>
            </View>
            <View style={styles.keyInfoBox}>
              <Text style={styles.LftTxt}>Expiry Date</Text>
              <Text style={styles.RgtTxt}>06/10/2026</Text>
            </View>
            <View style={styles.keyInfoBox}>
              <Text style={styles.LftTxt}>Location</Text>
              <Text style={styles.RgtTxt}>Installed it High</Text>
            </View>
          </View>
          <View style={styles.AddedInfocontainer}></View>
...
export default ClerkInventoryCompletedTasksReportAlarmDetails;
