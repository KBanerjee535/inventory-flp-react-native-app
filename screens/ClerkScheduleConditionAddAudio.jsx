...
import {ScheduleConditionsUpdateAudioApi} from '../services/apiService';

const audioRecorderPlayer = new AudioRecorderPlayer();

const ClerkScheduleConditionAddAudio = ({ navigation }) => {
   const { setRecordingPath ,recordingPath, scheduleConditions} = useUserContext();
...
console.log(JSON.stringify(fd));
    let response = await ScheduleConditionsUpdateAudioApi(fd);
...
export default ClerkScheduleConditionAddAudio;
