...
import { AlarmAddImageApi, AlarmUpdateTextByIdApi } from '../services/apiService';
import { launchCamera, launchImageLibrary } from 'react-native-image-picker';
 // Note the capitalization

const ClerkAddAlarmAddText = ({navigation}) => {
  const { alarmsData,seletedJobId } = useUserContext() || {};
...
const handleSaveText = async () => {
  ...
  try {//
    ...
    let response = await AlarmUpdateTextByIdApi(fd);
    console.log('Alarm Update Response:', response);
...
useEffect(() => {
  alarmsData?.id && setDescription(alarmsData?.description || '');
}, [alarmsData?.id]);
    ...
    <SafeAreaView style={styles.mainBody}>
      ...
      <View style={styles.Body}>
        ...
        <ScrollView style={styles.container}>
          ...
          <Text style={styles.infoTxt}>Please describe the alarm summary</Text>
...
export default ClerkAddAlarmAddText;
