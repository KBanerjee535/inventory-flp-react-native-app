...
const ClerkInventoryWaitingforApprovalReportkeysdetails = ({navigation}) => {
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('ClerkInventoryWaitingforApprovalReportkeys')
            }>
...
export default ClerkInventoryWaitingforApprovalReportkeysdetails;
