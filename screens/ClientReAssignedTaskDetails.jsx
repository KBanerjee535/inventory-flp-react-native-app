...
const ClientReAssignedTaskDetails = ({navigation}) => {
  return (
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text
                style={[styles.info, styles.AddBtn]}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.ReAssignedStyle}>Re Assigned</Text>
            </View>
            <View style={styles.row}>
...
export default ClientReAssignedTaskDetails;
