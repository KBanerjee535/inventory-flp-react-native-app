...
const ClerkInventoryWaitingforApprovalReportMetersDetails = ({navigation}) => {
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate(
                'ClerkInventoryWaitingforApprovalReportMeters',
              )
            }>
...
export default ClerkInventoryWaitingforApprovalReportMetersDetails;
