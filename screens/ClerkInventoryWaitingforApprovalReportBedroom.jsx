...
const items = [
  {
    ...
    text: 'Bedroom 1',
    screen: 'ClerkInventoryWaitingforApprovalReportBedroomDetails',
  },
  {
    id: 2,
    icon: <ItemIcon6 width={24} height={24} />,
...
const ClerkInventoryWaitingforApprovalReportBedroom = ({navigation}) => {
...
export default ClerkInventoryWaitingforApprovalReportBedroom;
