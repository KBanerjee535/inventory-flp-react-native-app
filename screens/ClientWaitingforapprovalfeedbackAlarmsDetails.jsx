...
const ClientWaitingforapprovalfeedbackAlarmsDetails = ({navigation}) => {
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate(
                'ClientWaitingforapprovalfeedbackReportAlarms',
              )
            }>
...
export default ClientWaitingforapprovalfeedbackAlarmsDetails;
