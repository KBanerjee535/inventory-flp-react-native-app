...
const ClerkInventoryCompletedTasksReportBedroomDetails = ({navigation}) => {
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate(
                'ClerkInventoryCompletedTasksReportBedroomlist',
              )
            }>
...
export default ClerkInventoryCompletedTasksReportBedroomDetails;
