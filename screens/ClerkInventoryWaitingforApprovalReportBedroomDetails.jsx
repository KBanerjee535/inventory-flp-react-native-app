...
const ClerkInventoryWaitingforApprovalReportBedroomDetails = ({navigation}) => {
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate(
                'ClerkInventoryWaitingforApprovalReportBedroom',
              )
            }>
...
export default ClerkInventoryWaitingforApprovalReportBedroomDetails;
