...
const AddNewSection = ({ navigation }) => {
    ...
    <SafeAreaView style={styles.mainBody}>
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          ...
          <Text style={styles.pagetitleTxt}>Add New Section</Text>
        </View>

        <ScrollView style={styles.container}>
          <Text style={styles.subtitel}>Section Title</Text>
          <TextInput style={styles.input} placeholder="Entrance & Hallway" />

          <Text style={styles.subtitel}>
            Select data recording option for description
          </Text>
          ...
          <View style={styles.OtherGap}>
            <View style={styles.newcontainer}>
              <View style={styles.section}>
                <Switch
                  value={roomAudio}
                  onValueChange={setRoomAudio}
                  trackColor={{ false: "#ccc", true: "#007AFF" }}
                  thumbColor={roomAudio ? "#0056b3" : "#f4f3f4"}
                />
                <Text style={styles.label}>Add items to this section</Text>
              </View>

              <View style={styles.sectionFixtures}>
                <TouchableOpacity style={styles.recordButton}>
                  <Text style={styles.recordText}>Fixtures & Fittings</Text>
                  <WhiteArrow />
                </TouchableOpacity>

                <TouchableOpacity style={styles.deleteIconaudio2}>
                  <Trash name="trash-outline" size={35} color="#393D47" />
                </TouchableOpacity>
              </View>
            </View>
            ...
            >
              <Text style={styles.NextBtn2Txt}>Add Item</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
