...
const items = [
  {
    ...
    screen: 'ClerkInventoryWaitingforApprovalReportkeysdetails',
  },
  {
    id: 2,
    icon: <ItemIcon3 width={24} height={24} />,
...
const ClerkInventoryWaitingforApprovalReportkeys = ({navigation}) => {
...
export default ClerkInventoryWaitingforApprovalReportkeys;
