...
const ClerkInventoryCompletedTasksReportKeysDetails = ({navigation}) => {
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('ClerkInventoryCompletedTasksReportKeyslist')
            }>
...
export default ClerkInventoryCompletedTasksReportKeysDetails;
