      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('ClientReAssignedTaskDetails')}>
            <PrevPageArrow style={styles.backIcon} />
          </TouchableOpacity>
          <Text style={styles.pagetitleTxt}>Add Tenant</Text>
        </View>
        ...
        <ScrollView style={styles.container}>
          ...
          <TextInput
            ...
            onBlur={() => setFocusedInput(null)}
          />
          <Text style={styles.subtitel}>Password</Text>
          <TextInput
            style={[
              styles.searchInput,
        ...
        <View style={styles.Footer}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('ClientReAssignedTaskDetails')}>
            <Text style={styles.NextBtnTxt}>Add Tenant</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
