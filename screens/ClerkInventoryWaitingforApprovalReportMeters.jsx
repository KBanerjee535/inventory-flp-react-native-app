...
const items = [
  {
    ...
    text: 'Water Meter',
    screen: 'ClerkInventoryWaitingforApprovalReportMetersDetails',
  },
  {
    id: 2,
    icon: <ItemIcon5 width={24} height={24} />,
...
const ClerkInventoryWaitingforApprovalReportMeters = ({navigation}) => {
...
export default ClerkInventoryWaitingforApprovalReportMeters;
