...
const items = [
  {
    ...
    screen: 'ClientWaitingforapprovalfeedbackReportSOC',
  },
  {
    id: 2,
    icon: <ItemIcon2 width={24} height={24} />,
    text: 'Cleaning Summary',
    screen: 'ClientWaitingforapprovalfeedbackCleaning',
  },
  {
    id: 3,
    icon: <ItemIcon3 width={24} height={24} />,
    text: 'Keys',
    screen: 'ClientWaitingforapprovalfeedbackReportkeys',
  },
  {
    id: 4,
    icon: <ItemIcon4 width={24} height={24} />,
    text: 'Alarms',
    screen: 'ClientWaitingforapprovalfeedbackReportAlarms',
  },
  {
    id: 5,
    icon: <ItemIcon5 width={24} height={24} />,
    text: 'Meters',
    screen: 'ClientWaitingforapprovalfeedbackMeters',
  },
  {
    id: 6,
    icon: <ItemIcon6 width={24} height={24} />,
    text: 'Bedroom',
    screen: 'ClientWaitingforapprovalfeedbackBedroom',
  },
  {
    id: 7,
