...
const ClerkInventoryCompletedTasksDetails = ({navigation}) => {
  const [isDisabled, setIsDisabled] = useState(true); // Change this to false when needed
  return (
      ...
      <View style={styles.Body}>
        ...
        <ScrollView style={styles.container}>
          <View style={styles.TopPart}>
            <Text style={styles.HeaderLftTxt}>22 Albert Street</Text>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.info}>22 Albert Street</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>Task Status</Text>
              <View style={styles.info}>
                <Text style={styles.InprogressStyle}>In Progress</Text>
              </View>
            </View>
            <View style={styles.row}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.info}>07/01/2025</Text>
            </View>
            <View style={styles.row}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.InspectedStyle}>Inspected</Text>
            </View>
            <View style={styles.row}>
            ...
            <View style={styles.row}>
              ...
              <Text style={[styles.info, styles.bold]}>Samuel Hall</Text>
            </View>
            <View style={styles.row}>
          ...
          <View style={styles.BtnGrp}>
            <TouchableOpacity
              ...
              <Text style={styles.StartBtnTxt}>View Report</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </View>
...
export default ClerkInventoryCompletedTasksDetails;
