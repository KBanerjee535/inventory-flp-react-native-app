...
import ClerkInventoryAssignedTasks from '../components/ClerkInventoryAssignedTasks';
import ClerkInventoryUpcomingTasks from '../components/ClerkInventoryUpcomingTasks';
import ClerkInventoryCompletedTasks from '../components/ClerkInventoryCompletedTasks';
import ClerkInventoryWaitingforapproval from '../components/ClerkInventoryWaitingforapproval';
import ClerkInventoryApproved from '../components/ClerkInventoryApproved';
  ...
  useFocusEffect(
    React.useCallback(() => {
      if (route.params?.activeTabIndex !== undefined) {
        setActiveTab(route.params.activeTabIndex);
      }
    }, [route.params]),
  );
      ...
      <View style={styles.Body}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.contentContainer}>
            {activeTab === 0 ? (
              <ClerkInventoryAssignedTasks navigation={navigation} />
            ) : activeTab === 1 ? (
              <ClerkInventoryUpcomingTasks navigation={navigation} />
            ) : activeTab === 2 ? (
              <ClerkInventoryCompletedTasks navigation={navigation} />
            ) : activeTab === 3 ? (
              <ClerkInventoryWaitingforapproval navigation={navigation} />
            ) : activeTab === 4 ? (
              <ClerkInventoryApproved navigation={navigation} />
            ) : null}
          </View>
        </View>
      </View>
