...
const items = [
  {
    ...
    text: 'Bedroom 1',
    screen: 'ClerkInventoryCompletedTasksReportBathroomDetails',
  },
];

const ClerkInventoryCompletedTasksReportBathroomlist = ({navigation}) => {
    ...
    <SafeAreaView style={styles.mainBody}>
      ...
      <View style={styles.Body}>
        <View style={styles.Header}>
          ...
          <Text style={styles.pagetitleTxt}>Bathroom</Text>
        </View>
...
export default ClerkInventoryCompletedTasksReportBathroomlist;
